...
public final class Assets {
  ...
  public static final class fonts {
    public static final AssetDescriptor<BitmapFont> DEFAULT = new AssetDescriptor<BitmapFont>("fonts/default.fnt", BitmapFont.class, new BitmapFontParameter("images/pack.atlas"));

    public static final AssetDescriptor[] ALL = {DEFAULT};
  }
  ...
  public static final class images {
    ...
    public static final AssetDescriptor<TextureRegion> BAR = new AssetDescriptor<TextureRegion>("images/pack.atlas#bar", TextureRegion.class, new TextureRegionLoader.TextureRegionParameter("images/pack.atlas", "bar"));
    ...
    public static final AssetDescriptor<TextureRegion> FONT = new AssetDescriptor<TextureRegion>("images/pack.atlas#font", TextureRegion.class, new TextureRegionLoader.TextureRegionParameter("images/pack.atlas", "font"));
    ...
    public static final AssetDescriptor<TextureRegion> HEALTH = new AssetDescriptor<TextureRegion>("images/pack.atlas#health", TextureRegion.class, new TextureRegionLoader.TextureRegionParameter("images/pack.atlas", "health"));
